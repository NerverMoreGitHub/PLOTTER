...
from PyQt5 import QtCore, QtWidgets#qt moudle
...
class ApplicationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.view_menu.addAction('&FPage',self.Fpage)
        self.view_menu.addAction('&SPage',self.Spage)
...
between qt4 and qt5"""
    ...
    def openFile(self):
        str_file_name = QtWidgets.QFileDialog.getOpenFileName(self,"打开文件","","Images (*.png *.xpm *.jpg)")
        print (str_file_name)
    def Fpage(self):
        self.sc.hide()
